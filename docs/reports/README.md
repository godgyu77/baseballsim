...
이 폴더에는 프로젝트의 최적화, 성능, 기능 상태, 보안 점검 등에 대한 보고서가 보관됩니다.
...
`{제목}_REPORT_{날짜}.md` 또는 `{제목}_AUDIT_{날짜}.md`

예시: 
- `API_OPTIMIZATION_REPORT_2025-12-01.md`
- `SECURITY_AUDIT_REACT2SHELL_2025-12-08.md`

## 📑 보고서 유형

- **최적화 보고서**: API 호출, 성능 최적화 관련
- **기능 상태 보고서**: 기능 개발 현황 및 상태
- **성능 분석 보고서**: 성능 측정 및 분석 결과
- **보안 점검 보고서**: 보안 취약점 점검 및 감사 결과
